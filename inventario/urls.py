...
urlpatterns = [
    ...
    path('ciclos/<int:ciclo_id>/transicionar/', views.transicionar_ciclo, name='transicionar_ciclo'),
    ...
    path('divergencias/<int:divergencia_id>/encerrar/', views.encerrar_divergencia_view, name='encerrar_divergencia'),
]
