...
SECRET_KEY = 'django-insecure-lts*=avsuyh#-f3nir&6$rp5ob#1=068_851j2(y#i)!%g_o_+'
...
# Security Settings for Iframe Preview
...
# Email settings
# Para desenvolvimento, usando servidor SMTP local para testes
