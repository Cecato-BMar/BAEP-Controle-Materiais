...
# Chave privada padrão para geração interna pelo usuário Master.
# Pode ser sobrescrita via variável de ambiente LICENSE_PRIVATE_KEY.
...
PRIVATE_KEY = os.getenv('LICENSE_PRIVATE_KEY', DEFAULT_PRIVATE_KEY)
